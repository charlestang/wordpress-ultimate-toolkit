		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>
						<p><input type="radio" id="wut-recent-posts-type-<?php echo $number; ?>" name="wut-recent-posts[<?php echo $number; ?>][type]" value="both" 
																					<?php
																					if ( $type == 'both' ) {
																						echo 'checked="checked"';}
																					?>
						/>both</p>
						<p><input type="radio" id="wut-recent-posts-type-<?php echo $number; ?>" name="wut-recent-posts[<?php echo $number; ?>][type]" value="page" 
																					<?php
																					if ( $type == 'page' ) {
																						echo 'checked="checked"';}
																					?>
						/>page only</p>
						<p><input type="radio" id="wut-recent-posts-type-<?php echo $number; ?>" name="wut-recent-posts[<?php echo $number; ?>][type]" value="post" 
																					<?php
																					if ( $type == 'post' ) {
																						echo 'checked="checked"';}
																					?>
				...
				<tr>
					...
					<td>
						<p><input type="radio" id="wut-recent-posts-password-<?php echo $number; ?>" name="wut-recent-posts[<?php echo $number; ?>][password]" value="show" 
																						<?php
																						if ( $password == 'show' ) {
																							echo 'checked="checked"';}
																						?>
						 />Show.</p>
						<p><input type="radio" id="wut-recent-posts-password-<?php echo $number; ?>" name="wut-recent-posts[<?php echo $number; ?>][password]" value="hide" 
																						<?php
																						if ( $password == 'hide' ) {
																							echo 'checked="checked"';}
																						?>
				...
				<tr>
					...
					<td>
						<p><input type="radio" id="wut-recent-posts-orderby-<?php echo $number; ?>" name="wut-recent-posts[<?php echo $number; ?>][orderby]" value="post_date" 
																					   <?php
																						if ( $orderby == 'post_date' ) {
																							echo 'checked="checked"';}
																						?>
						 />Post date.</p>
						<p><input type="radio" id="wut-recent-posts-orderby-<?php echo $number; ?>" name="wut-recent-posts[<?php echo $number; ?>][orderby]" value="post_modified" 
																					   <?php
		...
		<table>
			<tbody>
				...
				<tr>
					<td class="alignright"><?php _e( 'Order by:', 'wut' ); ?></td>
					<td>
						<p><input type="radio" id="wut-related-posts-orderby-<?php echo $number; ?>" name="wut-related-posts[<?php echo $number; ?>][orderby]" value="post_date" 
																						<?php
																						if ( $orderby == 'post_date' ) {
																							echo 'checked="checked"';}
																						?>
						 />Post date.</p>
						<p><input type="radio" id="wut-related-posts-orderby-<?php echo $number; ?>" name="wut-related-posts[<?php echo $number; ?>][orderby]" value="post_modified" 
																						<?php
																						if ( $orderby == 'post_modified' ) {
																							echo 'checked="checked"';}
																						?>
				...
				<td class="alignright"><?php _e( 'Order:', 'wut' ); ?></td>
					<td>
						<p><input type="radio" id="wut-related-posts-order-<?php echo $number; ?>" name="wut-related-posts[<?php echo $number; ?>][order]" value="desc" 
																					  <?php
																						if ( $order == 'desc' ) {
																							echo 'checked="checked"';}
																						?>
						 />Descend.</p>
						<p><input type="radio" id="wut-related-posts-order-<?php echo $number; ?>" name="wut-related-posts[<?php echo $number; ?>][order]" value="asc" 
																					  <?php
																						if ( $order == 'asc' ) {
																							echo 'checked="checked"';}
																						?>
				...
				<tr>
					<td class="alignright"><?php _e( 'Show password protected post?', 'wut' ); ?></td>
					<td>
						<p><input type="radio" id="wut-related-posts-password-<?php echo $number; ?>" name="wut-related-posts[<?php echo $number; ?>][password]" value="show" 
																						 <?php
																							if ( $password == 'show' ) {
																								echo 'checked="checked"';}
																							?>
						 />Show.</p>
						<p><input type="radio" id="wut-related-posts-password-<?php echo $number; ?>" name="wut-related-posts[<?php echo $number; ?>][password]" value="hide" 
																						 <?php
																							if ( $password == 'hide' ) {
																								echo 'checked="checked"';}
																							?>
		...
		<table>
			<tbody>
				...
				<tr>
					<td class="alignright"><?php _e( 'Post type to show:', 'wut' ); ?></td>
					<td>
						<p><input type="radio" id="wut-recent-comments-posttype-<?php echo $number; ?>" name="wut-recent-comments[<?php echo $number; ?>][posttype]" value="both" 
																						   <?php
																							if ( $posttype == 'both' ) {
																								echo 'checked="checked"';}
																							?>
						/>both</p>
						<p><input type="radio" id="wut-recent-comments-posttype-<?php echo $number; ?>" name="wut-recent-comments[<?php echo $number; ?>][posttype]" value="page" 
																						   <?php
																							if ( $posttype == 'page' ) {
																								echo 'checked="checked"';}
																							?>
						/>page only</p>
						<p><input type="radio" id="wut-recent-comments-posttype-<?php echo $number; ?>" name="wut-recent-comments[<?php echo $number; ?>][posttype]" value="post" 
																						   <?php
																							if ( $posttype == 'post' ) {
																								echo 'checked="checked"';}
																							?>
				...
				<tr>
					...
					<td>
						<p><input type="radio" id="wut-recent-comments-commenttype-<?php echo $number; ?>" name="wut-recent-comments[<?php echo $number; ?>][commenttype]" value="both" 
																							  <?php
																								if ( $commenttype == 'both' ) {
																									echo 'checked="checked"';}
																								?>
						/>both</p>
						<p><input type="radio" id="wut-recent-comments-commenttype-<?php echo $number; ?>" name="wut-recent-comments[<?php echo $number; ?>][commenttype]" value="comment" 
																							  <?php
																								if ( $commenttype == 'comment' ) {
																									echo 'checked="checked"';}
																								?>
						/>comments only</p>
						<p><input type="radio" id="wut-recent-comments-commenttype-<?php echo $number; ?>" name="wut-recent-comments[<?php echo $number; ?>][commenttype]" value="pingback" 
																							  <?php
																								if ( $commenttype == 'pingback' ) {
																									echo 'checked="checked"';}
																								?>
						/>pingback only</p>
					</td>
				...
				<tr>
					<td class="alignright"><?php _e( 'Show password protected post?', 'wut' ); ?></td>
					<td>
						<p><input type="radio" id="wut-recent-comments-password-<?php echo $number; ?>" name="wut-recent-comments[<?php echo $number; ?>][password]" value="show" 
																						   <?php
																							if ( $password == 'show' ) {
																								echo 'checked="checked"';}
																							?>
						 />Show.</p>
						<p><input type="radio" id="wut-recent-comments-password-<?php echo $number; ?>" name="wut-recent-comments[<?php echo $number; ?>][password]" value="hide" 
																						   <?php
																							if ( $password == 'hide' ) {
																								echo 'checked="checked"';}
																							?>
